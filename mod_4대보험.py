...
급여대장과 4대보험 공단(건강보험공단/국민연금공단/근로복지공단) 자료를 대조해
급여지급 전 보험료 입력 오류(금액불일치·입력누락·전월 퇴사자 여전히 부과)를
찾아 화면과 엑셀 리포트로 보여준다.
"""
...
from mod_4대보험_matcher import INSURANCE_ITEMS, classify_errors, merge_records
from mod_4대보험_parsers import (
    parse_employment_insurance,
    parse_health_insurance,
    parse_national_pension,
    parse_payroll,
)
from mod_4대보험_report import build_report
